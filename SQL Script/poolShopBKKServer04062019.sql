...
ON DUPLICATE KEY UPDATE `amphur_id` = VALUES(`amphur_id`), `amphur_code` = VALUES(`amphur_code`), `amphur_name` = VALUES(`amphur_name`), `geo_id` = VALUES(`geo_id`), `province_id` = VALUES(`province_id`);
...
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `bank_code` = VALUES(`bank_code`), `bank_name` = VALUES(`bank_name`), `bank_icons` = VALUES(`bank_icons`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
(1,	'PURAPOOL',	'1.jpg',	0),
(2,	'ASTRALPOOL',	'1.jpg',	1),
(3,	'Dolphin',	'1.jpg',	0),
(4,	'Emaux',	'1.jpg',	0),
(5,	'maytronics',	'1.jpg',	0)
ON DUPLICATE KEY UPDATE `id_brand` = VALUES(`id_brand`), `brand_name` = VALUES(`brand_name`), `brand_pic_url` = VALUES(`brand_pic_url`), `stdel` = VALUES(`stdel`);
...
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `carousel_path` = VALUES(`carousel_path`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
ON DUPLICATE KEY UPDATE `id_category_product` = VALUES(`id_category_product`), `category_product_name` = VALUES(`category_product_name`), `category_product_detail` = VALUES(`category_product_detail`), `stdel` = VALUES(`stdel`), `pic_url` = VALUES(`pic_url`);
...
(1,	'We are always ready to cooperate.Write to us and we will contact you.',	'info@handhealth.com',	'081-234-5678',	'25 Si Phum, Muang District, Chiang Mai 50200\r\n25 Si Phum, Muang District, Chiang Mai 50200\r\n25 Si Phum, Muang District, Chiang Mai 50200\r\nThailand',	'https://www.facebook.com/healthhandheart/',	'https://www.instagram.com',	'https://twitter.com/',	'089-876-5432s')
ON DUPLICATE KEY UPDATE `id_contact_us` = VALUES(`id_contact_us`), `contact_us_text_header` = VALUES(`contact_us_text_header`), `contact_us_email` = VALUES(`contact_us_email`), `contact_us_phone` = VALUES(`contact_us_phone`), `contact_us_address` = VALUES(`contact_us_address`), `contact_us_facebook_url` = VALUES(`contact_us_facebook_url`), `contact_us_twitter_url` = VALUES(`contact_us_twitter_url`), `contact_us_instagram_url` = VALUES(`contact_us_instagram_url`), `contact_us_phone1` = VALUES(`contact_us_phone1`);
...
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `iso` = VALUES(`iso`), `name` = VALUES(`name`), `nicename` = VALUES(`nicename`), `iso3` = VALUES(`iso3`), `numcode` = VALUES(`numcode`), `phonecode` = VALUES(`phonecode`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
(1,	'maytee',	'palamee',	'0827817908',	'80/3 ปล้อง เทิง เชียงราย 57160',	NULL,	45,	5934,	660,	4878,	0,	'66',	'2019-06-02 12:13:59',	'2019-06-02 12:13:59'),
(2,	'kheukpon',	'hongthong',	'0812223432',	'123/35 ถ.วงแหวน',	NULL,	45,	5934,	660,	4878,	0,	'66',	'2019-06-02 12:13:59',	'2019-06-02 12:13:59'),
(3,	'maytee',	'palamee',	'0827817908',	'80/3 ปล้อง เทิง เชียงราย 57160',	NULL,	45,	5934,	660,	4878,	0,	'66',	'2019-06-02 12:15:59',	'2019-06-02 12:15:59'),
(4,	'kheukpon',	'hongthong',	'0812223432',	'123/35 ถ.วงแหวน',	NULL,	45,	5934,	660,	4878,	0,	'66',	'2019-06-02 12:15:59',	'2019-06-02 12:15:59'),
(5,	'maytee',	'palamee',	'0827817908',	'80/3 ปล้อง เทิง เชียงราย 57160',	NULL,	45,	5934,	660,	4878,	0,	'66',	'2019-06-02 12:21:33',	'2019-06-02 12:21:33'),
(6,	'kheukpon',	'hongthong',	'0812223432',	'123/35 ถ.วงแหวน',	NULL,	45,	5934,	660,	4878,	0,	'66',	'2019-06-02 12:21:33',	'2019-06-02 12:21:33')
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `name` = VALUES(`name`), `lastname` = VALUES(`lastname`), `tel` = VALUES(`tel`), `address` = VALUES(`address`), `full_address` = VALUES(`full_address`), `province_id` = VALUES(`province_id`), `district_id` = VALUES(`district_id`), `amphur_id` = VALUES(`amphur_id`), `postcode_id` = VALUES(`postcode_id`), `geo_id` = VALUES(`geo_id`), `phone_code` = VALUES(`phone_code`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
(1,	'Kerry',	'https://th.kerryexpress.com/en/track/',	50.00,	1,	NULL,	'2019-04-25 14:19:36',	'2019-06-03 03:13:38')
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `service` = VALUES(`service`), `service_url` = VALUES(`service_url`), `service_charge` = VALUES(`service_charge`), `status` = VALUES(`status`), `deleted_at` = VALUES(`deleted_at`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
ON DUPLICATE KEY UPDATE `district_id` = VALUES(`district_id`), `district_code` = VALUES(`district_code`), `district_name` = VALUES(`district_name`), `amphur_id` = VALUES(`amphur_id`), `province_id` = VALUES(`province_id`), `geo_id` = VALUES(`geo_id`);
...
(1,	0,	'HH',	'2019-02-06 11:29:45',	'2019-02-07 04:02:32')
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `index` = VALUES(`index`), `prefix` = VALUES(`prefix`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
(1,	'1.jpg',	0)
ON DUPLICATE KEY UPDATE `id_home_carousel_main` = VALUES(`id_home_carousel_main`), `pic_url` = VALUES(`pic_url`), `stdel` = VALUES(`stdel`);
...
(3,	'Admin Store',	1),
(4,	'member',	0)
ON DUPLICATE KEY UPDATE `id_level` = VALUES(`id_level`), `level_name` = VALUES(`level_name`), `stdel` = VALUES(`stdel`);
...
ON DUPLICATE KEY UPDATE `id_menu` = VALUES(`id_menu`), `menu_name` = VALUES(`menu_name`), `stdel` = VALUES(`stdel`), `url` = VALUES(`url`);
...
(2,	'2019_02_07_101248_create_about_us_master_table',	1),
(3,	'2019_02_07_101248_create_amphur_table',	1),
(4,	'2019_02_07_101248_create_bank_information_table',	1),
(5,	'2019_02_07_101248_create_bank_master_table',	1),
(6,	'2019_02_07_101248_create_carousel_table',	1),
(7,	'2019_02_07_101248_create_category_product_master_table',	1),
(8,	'2019_02_07_101248_create_category_promotion_master_table',	1),
(9,	'2019_02_07_101248_create_contact_us_master_table',	1),
(10,	'2019_02_07_101248_create_country_table',	1),
(11,	'2019_02_07_101248_create_customers_table',	1),
(12,	'2019_02_07_101248_create_district_table',	1),
(13,	'2019_02_07_101248_create_gennerate_key_table',	1),
(14,	'2019_02_07_101248_create_home_carousel_main_master_table',	1),
(15,	'2019_02_07_101248_create_level_master_table',	1),
(16,	'2019_02_07_101248_create_menu_master_table',	1),
(17,	'2019_02_07_101248_create_order_table',	1),
(18,	'2019_02_07_101248_create_post_codes_table',	1),
(19,	'2019_02_07_101248_create_product_master_table',	1),
(20,	'2019_02_07_101248_create_promotion_master_table',	1),
(21,	'2019_02_07_101248_create_province_table',	1),
(22,	'2019_02_07_101248_create_relate_menu_level_table',	1),
(23,	'2019_02_07_101248_create_review_master_table',	1),
(24,	'2019_02_07_101248_create_users_table',	1),
(25,	'2019_02_07_104001_create_jobs_table',	1),
(26,	'2019_02_08_092428_create_delivery_table',	1),
(27,	'2019_02_09_213141_create_special_table',	1),
(28,	'2019_04_26_085306_create_brand_product_masters_table',	1),
(29,	'2019_05_25_092301_create_video_settings_table',	1)
...
(7510,	'380802',	'38000'),
(7511,	'380803',	'38000')
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `district_code` = VALUES(`district_code`), `post_code` = VALUES(`post_code`);
...
(76,	'96',	'นราธิวาส   ',	6),
(77,	'97',	'บึงกาฬ',	3)
ON DUPLICATE KEY UPDATE `province_id` = VALUES(`province_id`), `province_code` = VALUES(`province_code`), `province_name` = VALUES(`province_name`), `geo_id` = VALUES(`geo_id`);
...
(1,	'admin',	'admin',	'admin@gmail.com',	NULL,	'$2y$10$P6ky7nMVj1AlYBeBqo6gNul5MHUnrp8eR0HC3g2QONYiv3UD7APPy',	'RgOa15RC9USovD2UgReWLX9dzZmLsVSNZ2fJQ5nm25HjkMZ6cPlGqLdGnaOr',	'eVVqMmZWNFJoaUI0OW1pWjN0VGo=5cbee72f92cd9',	0,	0,	0,	NULL,	'2019-04-23 02:21:44',	'2019-04-23 03:21:35'),
(2,	'S25jS1M=5cbeda929caf6',	'kheukpon',	'kheukpon.h@gmail.com',	NULL,	'$2y$10$P6ky7nMVj1AlYBeBqo6gNul5MHUnrp8eR0HC3g2QONYiv3UD7APPy',	'XSC83ak9W9hnjcfIPmUKLp3xOt2WXjGFnMfeodcqxSuev83cBL9M9kLdKxKN',	'NzlnQ0ZnR2ozMGs1eFBoWFFxSE0=5ce655beeea71',	4,	0,	0,	NULL,	'2019-04-23 02:27:46',	'2019-05-23 01:11:43')
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `username` = VALUES(`username`), `name` = VALUES(`name`), `email` = VALUES(`email`), `email_verified_at` = VALUES(`email_verified_at`), `password` = VALUES(`password`), `remember_token` = VALUES(`remember_token`), `access_token` = VALUES(`access_token`), `roles` = VALUES(`roles`), `stdel` = VALUES(`stdel`), `stpic` = VALUES(`stpic`), `deleted_at` = VALUES(`deleted_at`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
(1,	'https://www.youtube.com/embed/ua7Z3deJtww',	'https://www.youtube.com/watch?v=ua7Z3deJtww',	1,	0,	NULL,	NULL,	'2019-05-27 13:30:20'),
(2,	'https://www.youtube.com/embed/y6OtzSXXnaw',	'https://www.youtube.com/watch?v=y6OtzSXXnaw',	1,	0,	NULL,	NULL,	'2019-05-28 14:18:15'),
(3,	'https://www.youtube.com/embed/xYglaBDyoiA',	'https://www.youtube.com/watch?v=xYglaBDyoiA',	1,	0,	NULL,	'2019-05-27 01:37:21',	'2019-05-28 14:28:14'),
(4,	'https://www.youtube.com/embed/yvMrVdpi6KQ',	'https://www.youtube.com/watch?v=yvMrVdpi6KQ',	0,	0,	NULL,	'2019-05-28 01:08:14',	'2019-05-28 14:31:28'),
(5,	'https://www.youtube.com/embed/xvs0mwPYrN0',	'https://www.youtube.com/watch?v=xvs0mwPYrN0',	1,	0,	NULL,	'2019-05-28 02:01:23',	'2019-05-28 14:52:42'),
(6,	'https://www.youtube.com/embed/xp2l15Ikpng',	'https://www.youtube.com/watch?v=xp2l15Ikpng',	0,	0,	NULL,	'2019-05-28 02:48:14',	'2019-05-28 14:17:43')
ON DUPLICATE KEY UPDATE `id_video` = VALUES(`id_video`), `video_url_embed` = VALUES(`video_url_embed`), `video_url` = VALUES(`video_url`), `status` = VALUES(`status`), `stdel` = VALUES(`stdel`), `deleted_at` = VALUES(`deleted_at`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
