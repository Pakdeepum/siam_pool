...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2019 at 01:22 PM
...
--
-- Table structure for table `brand_product_master`
--
...
--
-- Dumping data for table `brand_product_master`
--
...
--
-- Table structure for table `category_product_master`
--
...
--
-- Dumping data for table `category_product_master`
--
...
--
-- Table structure for table `category_promotion_master`
--

CREATE TABLE `category_promotion_master` (
  `id_category_promotion` int(11) NOT NULL,
...
(1, 'maytee', 'palamee', '0827817908', '80/3 ปล้อง เทิง เชียงราย 57160', NULL, 45, 5934, 660, 4878, 0, '66', '2019-05-29 08:51:55', '2019-05-29 08:51:55'),
(2, 'kheukpon', 'hongthong', '0812223432', '123/35 ถ.วงแหวน', '123/35 ถ.วงแหวน ช้างเผือก เมืองเชียงใหม่ เชียงใหม่ 50300', 38, 500107, 568, 4179, 1, '66', '2019-05-29 08:51:55', '2019-05-29 01:54:01');
...
(1, 'Kerry', 'https://th.kerryexpress.com/en/track/', 50.00, 1, NULL, '2019-04-25 14:19:36', '2019-06-03 20:27:41');
...
--
-- Table structure for table `gennerate_key`
--
...
--
-- Dumping data for table `gennerate_key`
--

INSERT INTO `gennerate_key` (`id`, `index`, `prefix`, `created_at`, `updated_at`) VALUES
(1, 1, 'HH', '2019-02-06 11:29:45', '2019-05-29 08:54:31');

-- --------------------------------------------------------

--
-- Table structure for table `home_carousel_main_master`
--

CREATE TABLE `home_carousel_main_master` (
  `id_home_carousel_main` int(11) NOT NULL,
  `pic_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stdel` int(11) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `home_carousel_main_master`
--
...
(1, '20190529HH0001', 1, 2, 1, 0.0000, 'MS0xMTU1OTEyMTQ2MQ==.png', '123/35 ถ.วงแหวน ช้างเผือก เมืองเชียงใหม่ เชียงใหม่ 50300', NULL, '2019-05-29 00:00:00', 6000.0000, 'KBANK', 2, 1, NULL, '2019-05-29 01:54:31', '2019-05-29 02:20:48'),
(2, '20190529HH0002', 1, 2, 1, 0.0000, 'MS0xMTU1OTEyMTQ2MQ==.png', '123/35 ถ.วงแหวน ช้างเผือก เมืองเชียงใหม่ เชียงใหม่ 50300', NULL, '2019-05-29 00:00:00', 6000.0000, 'KBANK', 2, 1, NULL, '2019-05-29 01:54:31', '2019-05-29 02:20:48'),
(3, '20190529HH0003', 2, 2, 1, 0.0000, 'MS0xMTU1OTEyMTQ2MQ==.png', '123/35 ถ.วงแหวน ช้างเผือก เมืองเชียงใหม่ เชียงใหม่ 50300', NULL, '2019-05-29 00:00:00', 6000.0000, 'KBANK', 2, 1, NULL, '2019-05-29 01:54:31', '2019-05-29 02:20:48');
...
(1, 'Purapool Chlorinators', 1, 1, 'detail', 1, 0, '1.png', 1, 'pc1', '2.png', '3.png', '4.png', '5.png', 6000, 'instruction', 'warning'),
...
--
-- Table structure for table `relate_menu_level`
--
...
(1, 'admin', 'admin', 'admin@gmail.com', NULL, '$2y$10$P6ky7nMVj1AlYBeBqo6gNul5MHUnrp8eR0HC3g2QONYiv3UD7APPy', 'DVoMyXMXt6N2uspF2bHnZN95q8NqcPxG9ihzWUBJDlUDt3FFUmPhaIcdIsK4', 'eVVqMmZWNFJoaUI0OW1pWjN0VGo=5cbee72f92cd9', 0, 0, 0, NULL, '2019-04-23 02:21:44', '2019-04-23 03:21:35'),
(2, 'S25jS1M=5cbeda929caf6', 'kheukpon', 'kheukpon.h@gmail.com', NULL, '$2y$10$P6ky7nMVj1AlYBeBqo6gNul5MHUnrp8eR0HC3g2QONYiv3UD7APPy', 'T8igO7oLRCBVUgKjQWbS5NLa2k28rkBcRlJ5Y5avBewMFOP3RIZNP5Ze0Bts', 'TUsxaDRvUkVmY3pHbjJEdzBUTlA=5cee459511103', 4, 0, 0, NULL, '2019-04-23 02:27:46', '2019-05-29 01:40:53');
...
--
-- Indexes for table `brand_product_master`
--
ALTER TABLE `brand_product_master`
...
--
-- Indexes for table `category_product_master`
--
ALTER TABLE `category_product_master`
  ADD PRIMARY KEY (`id_category_product`);

--
-- Indexes for table `category_promotion_master`
--
ALTER TABLE `category_promotion_master`
  ADD PRIMARY KEY (`id_category_promotion`);
...
--
-- Indexes for table `gennerate_key`
--
ALTER TABLE `gennerate_key`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `home_carousel_main_master`
--
ALTER TABLE `home_carousel_main_master`
  ADD PRIMARY KEY (`id_home_carousel_main`);
...
--
-- Indexes for table `promotion_master`
--
ALTER TABLE `promotion_master`
...
--
-- Indexes for table `relate_menu_level`
--
ALTER TABLE `relate_menu_level`
...
--
-- AUTO_INCREMENT for table `brand_product_master`
--
ALTER TABLE `brand_product_master`
...
--
-- AUTO_INCREMENT for table `category_product_master`
--
ALTER TABLE `category_product_master`
  MODIFY `id_category_product` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `category_promotion_master`
--
ALTER TABLE `category_promotion_master`
  MODIFY `id_category_promotion` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `district`
  MODIFY `district_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8915;

--
-- AUTO_INCREMENT for table `gennerate_key`
--
ALTER TABLE `gennerate_key`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `home_carousel_main_master`
--
ALTER TABLE `home_carousel_main_master`
  MODIFY `id_home_carousel_main` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `promotion_master`
--
ALTER TABLE `promotion_master`
...
--
-- AUTO_INCREMENT for table `relate_menu_level`
--
ALTER TABLE `relate_menu_level`
  MODIFY `id_relate` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `video_setting`
  MODIFY `id_video` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
