<!-- Modal Add -->
<form action="{{route('BackendBrandProduct.SaveEditBrand')}}" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
{{csrf_field()}}
  <!-- Modal -->
      <div class="container">
        <div class="row">
        <div class="modal" tabindex="-1" role="dialog" id="modal-EditBrand">
